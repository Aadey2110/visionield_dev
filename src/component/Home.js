  ...
  return (
    <main>
      <div className="flex flex-col md:flex-row text-white bg-gray-600 overflow-hidden">
        ...
        <div className="md:w-5/12 bg-gray-custom-2 md-bg-gray-600">
          <motion.img
            ...
            src=".\img\Home page about us.png"
            alt=""
          />
        </div>
      </div>
      <div className="bg-white flex flex-col md:flex-row-reverse px-10 pt-20 md:pt-40 gap-10 md:gap-20">
        <div className="md:w-5/12 flex flex-col pb-4 md:pb-40 pt-5 md:pt-10 gap-5 md:gap-10">
          ...
          <motion.div
            ...
            viewport={isMobile && { once: true }}
            transition={isMobile && { duration: 0.4, ease: "easeIn" }}
            className="text-md leading-7 font-light"
          >
        ...
        <div className="md:w-7/12">
          <img
            ...
            src=".\img\Crafting marketing and Sales solutions for Real estate projects.png"
            alt=""
          />
        </div>
      </div>
      <div className="w-full bg-white">
        ...
        <div className="bg-white flex flex-col md:flex-row justify-between pt-20 md:pt-52 px-10 gap-16 pb-40 overflow-y-hidden">
          <div className="flex flex-col md:w-1/3 pt-16 gap-10">
            <motion.div
              initial={isMobile && { opacity: 0 }}
              whileInView={isMobile && { opacity: 1 }}
              viewport={
          ...
          <div className="flex flex-col md:w-1/3 gap-6">
            <div className="overflow-hidden">
              <motion.img
                ...
                className="h-screen object-cover rounded-custom-2"
                src="./img/Home-Banner-4.jpg"
                alt=""
              />
            </div>
            <div>
              <div className="text-4xl font-semibold">Dean Mayster</div>
              <div className="text-lg font-medium">SOCIAL &amp; PPC EXPERT</div>
            </div>
          </div>
          <div className="flex flex-col md:w-1/3 gap-6">
            <div className="overflow-hidden">
              <motion.img
                initial={isMobile && { y: -585 }}
                whileInView={isMobile && { y: 0 }}
                viewport={
                  isMobile && { once: true, margin: "350px 0px -50px 0px" }
                }
