    ...
    <main>
      <div className="flex flex-col bg-gray-600">
        ...
        <div className="overflow-hidden">
          <motion.img
            ...
            src=".\img\We are project Visionaries or We are real estate Visionaries.png"
            alt=""
          />
        </div>
      </div>
        ...
        <motion.div className="flex flex-col md:pl-10 md:w-7/12 gap-5 mt-10 md:pt-10 md:pr-10 md:mt-0 overflow-y-hidden">
          <motion.div className="flex flex-col md:flex-row gap-5">
            <motion.div
              ...
              className="md:w-1/2 flex flex-col rounded-custom-3 px-5 py-9 mx-2 md:mx-0 shadow-custom"
            >
              <div className="">
                <img
                  className="mx-auto md:mx-0 w-16"
                  src=".\img\Photos for website1\Collaboration.png"
                  alt=""
                />
              </div>
            ...
            >
              <div className="">
                <img
                  className="mx-auto md:mx-0 w-16"
                  src=".\img\Photos for website1\Excellence.png"
                  alt=""
                />
              </div>
              <div className="text-center md:text-left font-medium text-4xl pt-4 pb-8">
          ...
          <div className="flex flex-col md:flex-row gap-5 md:pb-14">
            ...
            >
              <div className="">
                <img
                  className="mx-auto md:mx-0 w-16"
                  src=".\img\Photos for website1\Integrity.png"
                  alt=""
                />
              </div>
              <div className="text-center md:text-left font-medium text-4xl pt-4 pb-8">
            ...
            >
              <div className="">
                <img
                  className="mx-auto md:mx-0 w-16"
                  src=".\img\Photos for website1\Customer centric.png"
                  alt=""
                />
              </div>
              <div className="text-center md:text-left font-medium text-4xl pt-4 pb-8">
      ...
      <div className="flex flex-col-reverse md:flex-row-reverse mt-40 md:mt-40 gap-12 md:gap-36 px-8 md:px-14 mb-16 md:mb-44">
          ...
          <div className="flex flex-col gap-20">
            ...
            >
              ...
              <div className="text-sm md:text-base text-center md:text-left leading-6">
                Our mission is to revolutionizeVadodara's Residential Real
        ...
        <div className="md:w-7/12 h-custom-1 md:h-auto overflow-y-hidden">
          <motion.img
            className="w-full h-full object-cover rounded-custom-3 md:mt-4"
            src=".\img\Vision, mission and philosophy.png"
            alt=""
          />
        </div>
      </div>
      <div className="mb-16 md:mb-48 bg-white">
        ...
        <div className="flex flex-col md:flex-row justify-between md:ml-5 mb-2 overflow-y-hidden">
          <div className="md:w-1/4 text-2xl text-center md:text-left mb-4 md:mb-0">
            <motion.img
              ...
              className="flex flex-col rounded-custom-3 h-custom px-8 pt-6 md:pt-0 md:px-0 md:pr-5 md:pb-4 object-cover"
